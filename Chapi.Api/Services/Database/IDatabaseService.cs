...
namespace Chapi.Api.Services.Database
{
    public interface IDatabaseService
    {
        ...
        Task<T?> GetItemByIdAsync<T>(string id, CancellationToken cancellationToken = default) where T : IDatabaseItemWithId;
        ...
        Task<List<T>> ListItemsAsync<T>(KeyValuePair<string, string> query, CancellationToken cancellationToken = default) where T : IDatabaseItemWithId;
